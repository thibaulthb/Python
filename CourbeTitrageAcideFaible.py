...
def concentration(Vb):#Calcule [H3O+]
    Ka=10**(-pKa)
    a=Cb*Vb/(Vb+Va)+Ka# a, b et c les coefficients du polynÃ´me
...
#---------------------------remplacer  les points dÃ©cimaux par des virgules :
...
plt.title("Titrage pH-métrique d'un acide faible")
...
fig.savefig('CourbeTitrageAcideFaible.png', transparent=False, dpi=150)# Création image PNG (adapter la résolution au résultat souhaité)
