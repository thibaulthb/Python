...
plt.title("Titrage pH-métrique d'une base forte")
...
fig.savefig('CourbeTitrageBaseForte.png', transparent=False, dpi=150)# Création image PNG (adapter la résolution au résultat souhaité)
